...
public function send_reminder_auto_pending($comp_id,$customer_id,$loan_id){
	...
	$restoration = $loan_restoration->restration;
	$massage = 'Ndugu Mteja malipo yako ya leo Halijapokelewa '.' '. $comp_name .' '. 'Epuka Kuchajiwa  Faini Ya Kulaza Rejesho kwa Kutokulipa kwa Wakati Ahsante.';
	//    echo "<pre>";
	// print_r($phone);
	//      exit();
	$this->sendsms($phone,$massage);
...
public function sendsms($phone,$massage){
	...
	$api_key = 'bNAK0cDwkulXG/DAVROJuxB/Ih';
  $ch = curl_init();
